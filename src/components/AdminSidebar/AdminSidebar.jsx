...
export default function AdminSidebar() {
  ...
  return (
    <div className={`bg-white h-screen w-72 duration-300 relative ${open ? "w-72" : "w-20"}`}>
      <BsArrowLeftShort className={`bg-white text-3xl rounded-full absolute -right-3 top-9 border border-purple-950 cursor-pointer duration-300' ${!open && "rotate-180"}`} onClick={() => setOpen(!open)} />
